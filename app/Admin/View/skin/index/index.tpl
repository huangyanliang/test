...
<!--  <div class="menu-admin">  
  ...
  <div class="menu-admin">  
   <div class="menu-header2">{:icon('th-large')} 服务管理 {:icon('menu-down','b')}</div>
   <div class="menu-dd"><a href="{:U('website/aboutlist','tables=advantage')}" target="right">{:icon('th')}服务管理</a></div> 
  </div>
  <div class="menu-admin">  
  ...
  <div class="menu-admin">  
   <div class="menu-header2">{:icon('list-alt')} 产品管理 {:icon('menu-down','b')}</div>
  ...
  <div class="menu-admin">  
   <div class="menu-header2">{:icon('list-alt')} 方案管理 {:icon('menu-down','b')}</div>
   <div class="menu-dd"><a href="{:U('website/datatypelist','tables=programtype')}" target="right">{:icon('tags')}类别管理</a></div> 
   <div class="menu-dd"><a href="{:U('website/datalist','tables=program&martables=programtype')}" target="right">{:icon('list-alt')}方案管理</a></div>
  </div>
  <div class="menu-admin">  
   <div class="menu-header2">{:icon('list-alt')} 案例管理 {:icon('menu-down','b')}</div>
