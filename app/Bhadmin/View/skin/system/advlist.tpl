...
<block name="main">
 <div class="pubmain">
 <h1>广告管理<div class="pull-right">{:btn(array('vals'=>'添加广告','size'=>3,'icon'=>'plus','scene'=>'primary','url'=>U('system/advadd')))}</div></h1>
 <form name="publist" method="post" action="" onSubmit="return pubdel(document.publist)"> 
  <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" class="{:tabstyle()}">
   <tr class="active">
     ...
     <td align="left" valign="middle">广告名称</td>
     <td width="220" align="left" valign="middle">广告位置</td>
     <td width="100" align="center" valign="middle">排序</td>
     <td width="100" align="center" valign="middle">宽度px</td>
     <td width="100" align="center" valign="middle">高度px</td>
   ...
   <tr class="maintr">
    ...
    <td align="left" valign="middle"><input type="text" class="hidetext" value="{$obj['remark']}"></td>
    <td align="center" valign="middle">{:modord($obj['ord'],$obj['Id'],$dshow['table'])}</td>
    <td align="center" valign="middle">{$obj['picwidth']}</td>
    <td align="center" valign="middle">{$obj['picheight']}</td>
    <td align="center" valign="middle">{:modattr($obj['Id'],$obj['enabled'],$dshow['table'])}</td>
    <td align="center" valign="middle">{:btn(array('vals'=>'编辑','icon'=>'edit','tips'=>'点击编辑数据','url'=>U('system/advmod','tables='.$dshow['table'].'&id='.$obj['Id'])))}</td>
   </tr>
   </volist>
   <tr>
