...
<head>
 ...
 <link href="/fxcl/public/Admin/css/index.css" rel="stylesheet">
 <script src="/fxcl/public/Admin/js/jquery.scorll.js"></script>
 <script src="/fxcl/public/Admin/js/index.js"></script>
...
<!--  <div class="menu-admin">  
  ...
  <div class="menu-admin">  
   <div class="menu-header2"><?php echo icon('th-large');?> 服务管理 <?php echo icon('menu-down','b');?></div>
   <div class="menu-dd"><a href="<?php echo U('website/aboutlist','tables=advantage');?>" target="right"><?php echo icon('th');?>服务管理</a></div> 
  </div>
  <div class="menu-admin">  
  ...
  <div class="menu-admin">  
   <div class="menu-header2"><?php echo icon('list-alt');?> 产品管理 <?php echo icon('menu-down','b');?></div>
  ...
  <div class="menu-admin">  
   <div class="menu-header2"><?php echo icon('list-alt');?> 方案管理 <?php echo icon('menu-down','b');?></div>
   <div class="menu-dd"><a href="<?php echo U('website/datatypelist','tables=programtype');?>" target="right"><?php echo icon('tags');?>类别管理</a></div> 
   <div class="menu-dd"><a href="<?php echo U('website/datalist','tables=program&martables=programtype');?>" target="right"><?php echo icon('list-alt');?>方案管理</a></div>
  </div>
  <div class="menu-admin">  
   <div class="menu-header2"><?php echo icon('list-alt');?> 案例管理 <?php echo icon('menu-down','b');?></div>
 ...
 <div id="rightmain">
     ...
     <b>当前位置：<a href="<?php echo U('index/main');?>" target="right">系统首页</a> <img src="/fxcl/public/Admin/images/map_right.png" /> 管理中心 <img src="/fxcl/public/Admin/images/map_right.png" /> <?php echo ($adminmemu[$tabid]); ?></b> 
     </div>
