 ...
 <div class="pubmain">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="<?php echo tabstyle();?>">
   <tr>
    ...
    <td height="32" align="left"><input type="text" value="<?php echo ($data['topic']); ?>" name="topic" class="textlong"> <span class="text-warning"> * </span></td>
   </tr>
   <tr>
   ...
   <tr class="hide">
     ...
     <td height="32" align="left"><input type="text" value="<?php echo ($data['linkurl']); ?>" name="linkurl" class="textlong"> <span class="text-warning">&nbsp;注：跳转链接请提填此项，没有请勿填写。</span></td>
   </tr>
   <tr class="hide">
     <td height="32" align="right" valign="middle">资料来源：</td>
     <td height="32" align="left"><input type="text" value="<?php echo ($data['source']); ?>" name="source" class="textsort">&nbsp;&nbsp;作者：<input type="text" value="<?php echo ($data['author']); ?>" name="author" class="textsort" ></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">资料简介：</td>
     <td height="32" align="left"><textarea name="intro" rows="6" cols="80" class="textareatext"><?php echo ($data['intro']); ?></textarea>&nbsp;<span class="text-warning">(资料简介，没有要求填写，可以为空！)</span></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">上传图片：</td>
     <td height="32" align="left"><?php echo uppic($data['pic'],'资料配图，没有要求可以不用上传！');?></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">资料内容：</td>
     <td height="32" align="left"><textarea name="content" class="pubtextarea" style="width:90%;height:450px;"><?php echo showdata($data['content']);?></textarea></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">关键词：</td>
     <td height="32" align="left"><textarea name="keyword" rows="6" cols="80" class="textareatext"><?php echo ($data['keyword']); ?></textarea><span class="text-warning">&nbsp;(资料关键词，未填的话，默认标题为关键词)</span></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">页面描述：</td>
     <td height="32" align="left"><textarea name="metades" rows="6" cols="80" class="textareatext"><?php echo ($data['metades']); ?></textarea><span class="text-warning">&nbsp;(资料描述，未填的话，默认标题为页面描述)</span></td>
   </tr>
   <tr class="hide">
     <td height="32" align="right" valign="middle">标题颜色：</td>
     <td height="32" align="left"><input type="text" value="<?php echo ($data['topiccolor']); ?>" name="topiccolor" class="textsort colorselect"<?php echo tooltip('标题颜色')?> style="width:120px;"></td>
   </tr>
   <tr class="hide">
   ...
   <tr class="hide">
     ...
     <td height="32" align="left"><?php echo checkbox($data['isstrong'],0,'isstrong');?> <span class="text-warning"> 注：勾选表示加粗资料标题</span></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">是否置顶：</td>
     <td height="32" align="left"><?php echo checkbox($data['istop'],0,'istop');?> <span class="text-warning"> 注：勾选表示启用</span></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td height="32" align="left"><input type="text" value="<?php echo ($data['ord']); ?>" name="ord" class="textsort"></td>
   </tr>
   <tr>
     <td height="32" align="right" valign="middle">发布日期：</td>
     <td height="32" align="left">
      <div class="input-group input-group-sm" style="width:300px;"><input type="text" value="<?php echo ($data['date']); ?>" name="date" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="form-control"><span class="input-group-addon"><?php echo icon('calendar');?></span></div>
     </td>
   </tr>
   <tr>
