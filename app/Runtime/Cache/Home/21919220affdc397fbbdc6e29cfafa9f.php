...
<div class="nav"> 
    ...
    <div class="left_menu">
        ...
        <div class="left_menu_D">
          <ul>
          <?php if(is_array($programtype)): $i = 0; $__LIST__ = $programtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$protypeobj): $mod = ($i % 2 );++$i;?><li <?php if($protypeobj['Id'] == $data['inftype']): ?>class='left_ul_lis'<?php else: ?>class='left_ul_li'<?php endif; ?>><a href="<?php echo U('index/programlist','inftype='.$protypeobj['Id']);?>"><?php echo ($protypeobj['topic']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
      ...
      <div class="right">
        <div class="right_t"><strong><?php echo ($metatitle); ?></strong><span>当前位置 > <a href="<?php echo U('index/index');?>">首页</a> > <a href="<?php echo U('index/programlist');?>">方案</a> > <a href="<?php echo U('index/programlist','inftype='.$data['inftype']);?>"><?php echo ($metatitle); ?></a></span></div>
        <div class="right_con">
