...
<div class="left_menu">
    ...
    <div class="left_menu_D">
      <ul>
      	<?php if(is_array($advanNav)): $i = 0; $__LIST__ = $advanNav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$advanobj): $mod = ($i % 2 );++$i;?><li <?php if($advanobj['Id'] == $id): ?>class='left_ul_lis'<?php else: ?>class='left_ul_li'<?php endif; ?>><a href="<?php echo U('index/advantage','id='.$advanobj['Id']);?>"><?php echo ($advanobj['topic']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
      </ul>
    </div>
  ...
  <div class="right">
    <div class="right_t"><strong><?php echo ($advan['topic']); ?></strong><span>当前位置 > <a href="<?php echo U('index/index');?>">首页</a> > <?php echo ($advan['topic']); ?></span></div>
    <div class="right_con"><?php echo ($advan['content']); ?></div>
  </div>
</div>
