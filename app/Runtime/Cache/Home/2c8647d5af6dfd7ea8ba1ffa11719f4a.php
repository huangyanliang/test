...
<div class="nav"> 
    ...
    <div class="left_menu">
      ...
      <div class="right">
        <div class="right_t"><strong><?php echo ($metatitle); ?></strong><span>当前位置 > <a href="<?php echo U('index/index');?>">首页</a> > <a href="<?php echo U('index/prolist');?>">产品展示</a> > <a href="<?php echo U('index/prolist','inftype='.$data['inftype']);?>"><?php echo ($metatitle); ?></a></span></div>
        <div class="right_con">
