...
<div class="nav"> 
    ...
    <div class="left_menu">
        ...
        <div class="left_menu_D">
          <ul>
          <?php if(is_array($programtype)): $i = 0; $__LIST__ = $programtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$programtypes): $mod = ($i % 2 );++$i;?><li <?php if($programtypes['Id'] == $inftype): ?>class='left_ul_lis'<?php else: ?>class='left_ul_li'<?php endif; ?>><a href="<?php echo U('index/programlist','inftype='.$programtypes['Id']);?>"><?php echo ($programtypes['topic']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
      ...
      <div class="right">
        <div class="right_t"><strong><?php echo ($metatitle); ?></strong><span>当前位置 > <a href="<?php echo U('index/index');?>">首页</a> > <a href="<?php echo U('index/programlist');?>">方案</a> > <?php echo ($metatitle); ?></span></div>
        <div class="right_con" style="padding:6px;">
        <?php if(is_array($program)): $i = 0; $__LIST__ = $program;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$programs): $mod = ($i % 2 );++$i;?><div class="boxss" style="margin:20px 0px 0px 20px;">
                <a href="<?php echo U('index/programshow','id='.$programs['Id']);?>" title="<?php echo ($programs['topic']); ?>"><img src="/fxcl/uploads/<?php echo ($programs['pic']); ?>" width="250" height="190" alt="<?php echo ($programs['topic']); ?>" />
                <div class="box_dds"><h3><?php echo ($programs['topic']); ?></h3><span class="ell2"><?php echo ($programs['intro']); ?></span></div></a>
