	...
	<div class="main">
		<div class="left_menu">
			...
			<div class="left_menu_D">
				<ul>
					<?php if(is_array($newtype)): $i = 0; $__LIST__ = $newtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newtypeobj): $mod = ($i % 2 );++$i;?><li <?php if($newtypeobj['Id'] == $data['inftype']): ?>class='left_ul_lis'
							<?php else: ?>class='left_ul_li'<?php endif; ?>>
							<a href="<?php echo U('index/newlist','inftype='.$newtypeobj['Id']);?>"><?php echo ($newtypeobj['topic']); ?></a>
			...
			<div class="contactBox">
				...
				<dl>
					<dt><img src="/fxcl/public/Home/images/tell.png" /></dt>
					<dd>Tel：<?php echo ($sysconf['tel']); ?></dd>
					<dt><img src="/fxcl/public/Home/images/faxs.png" /></dt>
					<dd>Fax：<?php echo ($sysconf['fax']); ?></dd>
					<dt><img src="/fxcl/public/Home/images/email.png" /></dt>
					<dd>Email：<?php echo ($sysconf['email']); ?></dd>
					<dt style="border:0px;"><img src="/fxcl/public/Home/images/addss.png" /></dt>
					<dd style="border:0px;">Add：<?php echo ($sysconf['address']); ?></dd>
				</dl>
			</div>
		</div>

		<div class="right">
			<div class="right_t"><strong><?php echo ($metatitle); ?></strong><span>当前位置 > <a href="<?php echo U('index/index');?>">首页</a> > <a href="<?php echo U('index/newlist');?>">新闻动态</a> > <a href="<?php echo U('index/newlist','inftype='.$data['inftype']);?>"><?php echo ($metatitle); ?></a></span></div>
			<div class="right_con">
