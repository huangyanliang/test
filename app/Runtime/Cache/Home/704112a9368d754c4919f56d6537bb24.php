...
<div class="nav"> 
    ...
    <li <?php if($mark == 'about'): ?>class="navs"<?php endif; ?>><a href="<?php echo U('index/about','id=1');?>">关于我们</a>
    	<div class="navShow">
    		<div id="navShow_l">
    			<?php if(is_array($aboutNav)): $i = 0; $__LIST__ = $aboutNav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aboutNavs): $mod = ($i % 2 );++$i;?><a href="<?php echo U('index/aboutus','id='.$aboutNavs['Id']);?>"><?php echo ($aboutNavs['topic']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
    		</div>
    		<div id="navShow_r">
    			<?php if(is_array($aboutNav)): $i = 0; $__LIST__ = array_slice($aboutNav,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$aboutTops): $mod = ($i % 2 );++$i;?><dl>
			        <dt><a href="<?php echo U('index/aboutus','id='.$aboutTops['Id']);?>"><img src="/fxcl/uploads/<?php echo ($aboutTops['pic']); ?>"/></a></dt>
			        <dd><a href="<?php echo U('index/aboutus','id='.$aboutTops['Id']);?>"><?php echo ($aboutTops['topic']); ?></a></dd>
			      </dl><?php endforeach; endif; else: echo "" ;endif; ?>
    		</div>
    	</div>
    </li>
    ...
    <div class="left_menu">
        ...
        <div class="left_menu_D">
          <ul>
          <?php if(is_array($casetype)): $i = 0; $__LIST__ = $casetype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$casetypeobj): $mod = ($i % 2 );++$i;?><li <?php if($casetypeobj['Id'] == $data['inftype']): ?>class='left_ul_lis'<?php else: ?>class='left_ul_li'<?php endif; ?>><a href="<?php echo U('index/caselist','inftype='.$casetypeobj['Id']);?>"><?php echo ($casetypeobj['topic']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
      ...
      <div class="right">
        <div class="right_t"><strong><?php echo ($metatitle); ?></strong><span>当前位置 > <a href="<?php echo U('index/index');?>">首页</a> > <a href="<?php echo U('index/caselist');?>">应用案例</a> > <a href="<?php echo U('index/caselist','inftype='.$data['inftype']);?>"><?php echo ($metatitle); ?></a></span></div>
        <div class="right_con">
